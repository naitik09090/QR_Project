...
import FacebookPageQRCodeLandingPage from '../Social Media/FacebookPageQRCodeLandingPage';
...
describe('FacebookPageQRCodeLandingPage Details', () => {

    test('FacebookPageQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<FacebookPageQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Facebook Page QR Codes/i);
        expect(screen.getByLabelText(/Facebook Page URL/i)).toBeInTheDocument();
    });

    test('FacebookPageQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<FacebookPageQRCodeLandingPage />);
