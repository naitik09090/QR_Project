...
import BarMenuQRCodeLandingPage from '../Restaurant & Hospitality/BarMenuQRCodeLandingPage';
...
describe('BarMenuQRCodeLandingPage Details', () => {

    test('BarMenuQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<BarMenuQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Bar QR Menus/i);
        expect(screen.getByLabelText(/Bar or Pub Name/i)).toBeInTheDocument();
    });

    test('BarMenuQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<BarMenuQRCodeLandingPage />);
