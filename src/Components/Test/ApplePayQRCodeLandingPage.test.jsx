...
import ApplePayQRCodeLandingPage from '../Payment_Qr_Pages/ApplePayQRCodeLandingPage';
...
describe('ApplePayQRCodeLandingPage Details', () => {

    test('ApplePayQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<ApplePayQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Apple Pay QR Codes/i);
        expect(screen.getByLabelText(/Business Name/i)).toBeInTheDocument();
    });

    test('ApplePayQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<ApplePayQRCodeLandingPage />);
