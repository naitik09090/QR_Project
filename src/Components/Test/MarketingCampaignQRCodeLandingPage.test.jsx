...
import MarketingCampaignQRCodeLandingPage from '../Business & Marketing/MarketingCampaignQRCodeLandingPage';
...
describe('MarketingCampaignQRCodeLandingPage Details', () => {

    test('MarketingCampaignQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<MarketingCampaignQRCodeLandingPage />);
        expect(screen.getAllByText(/Marketing Campaigns/i)[0]).toBeInTheDocument();
        expect(screen.getByLabelText(/Campaign Destination URL/i)).toBeInTheDocument();
    });

    test('MarketingCampaignQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<MarketingCampaignQRCodeLandingPage />);
    ...
    test('simulates user input and QR code generation', async () => {
        ...
        render(
            <HelmetProvider>
                <MarketingCampaignQRCodeLandingPage />
            </HelmetProvider>
        );
