...
import TikTokQRCodeLandingPage from '../Social Media/TikTokQRCodeLandingPage';
...
describe('TikTokQRCodeLandingPage Details', () => {

    test('TikTokQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<TikTokQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/TikTok QR Codes/i);
        expect(screen.getByLabelText(/Profile or Video Link/i)).toBeInTheDocument();
    });

    test('TikTokQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<TikTokQRCodeLandingPage />);
