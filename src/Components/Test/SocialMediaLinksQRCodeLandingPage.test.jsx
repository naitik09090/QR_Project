...
import SocialMediaLinksQRCodeLandingPage from '../Social Media/SocialMediaLinksQRCodeLandingPage';
...
describe('SocialMediaLinksQRCodeLandingPage Details', () => {

    test('SocialMediaLinksQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<SocialMediaLinksQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/One QR Code for All Your Links/i);
        expect(screen.getByLabelText(/Hub Label \/ Display Name/i)).toBeInTheDocument();
    });

    test('SocialMediaLinksQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<SocialMediaLinksQRCodeLandingPage />);
    ...
    test('simulates user input and QR code generation', async () => {
        ...
        render(
            <HelmetProvider>
                <SocialMediaLinksQRCodeLandingPage />
            </HelmetProvider>
        );
