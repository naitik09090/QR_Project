...
import EmailSignatureQRCodeLandingPage from '../Business & Marketing/EmailSignatureQRCodeLandingPage';
...
describe('EmailSignatureQRCodeLandingPage Details', () => {

    test('EmailSignatureQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<EmailSignatureQRCodeLandingPage />);
        expect(screen.getAllByText(/Email Signature/i)[0]).toBeInTheDocument();
        expect(screen.getByLabelText(/Full Name/i)).toBeInTheDocument();
    });

    test('EmailSignatureQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<EmailSignatureQRCodeLandingPage />);
    ...
    test('simulates user input and QR code generation', async () => {
        ...
        render(
            <HelmetProvider>
                <EmailSignatureQRCodeLandingPage />
            </HelmetProvider>
        );
