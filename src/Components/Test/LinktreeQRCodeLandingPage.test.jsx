...
import LinktreeQRCodeLandingPage from '../Social Media/LinktreeQRCodeLandingPage';
...
describe('LinktreeQRCodeLandingPage Details', () => {

    test('LinktreeQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<LinktreeQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Linktree QR Codes/i);
        expect(screen.getByLabelText(/Linktree URL /i)).toBeInTheDocument();
    });

    test('LinktreeQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<LinktreeQRCodeLandingPage />);
