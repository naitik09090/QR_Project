...
import BusinessWebsiteQRCodeLandingPage from '../Business & Marketing/BusinessWebsiteQRCodeLandingPage';
...
describe('BusinessWebsiteQRCodeLandingPage Details', () => {

    test('BusinessWebsiteQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<BusinessWebsiteQRCodeLandingPage />);
        expect(screen.getAllByText(/Business Websites/i)[0]).toBeInTheDocument();
        expect(screen.getByLabelText(/Enter Your Website URL/i)).toBeInTheDocument();
    });

    test('BusinessWebsiteQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<BusinessWebsiteQRCodeLandingPage />);
    ...
    test('simulates user input and QR code generation', async () => {
        ...
        render(
            <HelmetProvider>
                <BusinessWebsiteQRCodeLandingPage />
            </HelmetProvider>
        );
