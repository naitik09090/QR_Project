...
import SnapchatQRCodeLandingPage from '../Social Media/SnapchatQRCodeLandingPage';
...
describe('SnapchatQRCodeLandingPage Details', () => {

    test('SnapchatQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<SnapchatQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Snapchat QR Codes/i);
        expect(screen.getByLabelText(/Snapchat Profile or Lens Link/i)).toBeInTheDocument();
    });

    test('SnapchatQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<SnapchatQRCodeLandingPage />);
