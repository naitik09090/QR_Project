...
import PowerPointQRCodeLandingPage from '../Files & Tools/PowerPointQRCodeLandingPage';
...
describe('PowerPointQRCodeLandingPage Details', () => {

    test('PowerPointQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<PowerPointQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/PowerPoint to QR Code/i);
        expect(screen.getByLabelText(/PowerPoint \/ Slides URL/i)).toBeInTheDocument();
    });

    test('PowerPointQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<PowerPointQRCodeLandingPage />);
