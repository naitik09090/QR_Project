...
import RestaurantOrderingQRCodeLandingPage from '../Restaurant & Hospitality/RestaurantOrderingQRCodeLandingPage';
...
describe('RestaurantOrderingQRCodeLandingPage Details', () => {

    test('RestaurantOrderingQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<RestaurantOrderingQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Restaurant Ordering/i);
        expect(screen.getByLabelText(/Restaurant Name/i)).toBeInTheDocument();
    });

    test('RestaurantOrderingQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<RestaurantOrderingQRCodeLandingPage />);
    ...
    test('simulates user input and QR code generation', async () => {
        ...
        render(
            <HelmetProvider>
                <RestaurantOrderingQRCodeLandingPage />
            </HelmetProvider>
        );
