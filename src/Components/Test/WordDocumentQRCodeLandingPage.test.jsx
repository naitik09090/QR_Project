...
import WordDocumentQRCodeLandingPage from '../Files & Tools/WordDocumentQRCodeLandingPage';
...
describe('WordDocumentQRCodeLandingPage Details', () => {

    test('WordDocumentQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<WordDocumentQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Word to QR Code/i);
        expect(screen.getByLabelText(/Word Document URL/i)).toBeInTheDocument();
    });

    test('WordDocumentQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<WordDocumentQRCodeLandingPage />);
