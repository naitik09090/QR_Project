...
import PayPalPaymentQRCodeLandingPage from '../Payment_Qr_Pages/PayPalPaymentQRCodeLandingPage';
...
describe('PayPalPaymentQRCodeLandingPage Details', () => {

    test('PayPalPaymentQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<PayPalPaymentQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/PayPal Payment QR Codes/i);
        expect(screen.getByLabelText(/PayPal Email \/ Merchant ID/i)).toBeInTheDocument();
    });

    test('PayPalPaymentQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<PayPalPaymentQRCodeLandingPage />);
    ...
    test('simulates user input and QR code generation', async () => {
        ...
        render(
            <HelmetProvider>
                <PayPalPaymentQRCodeLandingPage />
            </HelmetProvider>
        );
