...
import ProductPackagingQRCodeLandingPage from '../Business & Marketing/ProductPackagingQRCodeLandingPage';
...
describe('ProductPackagingQRCodeLandingPage Details', () => {

    test('ProductPackagingQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<ProductPackagingQRCodeLandingPage />);
        expect(screen.getAllByText(/Product Packaging/i)[0]).toBeInTheDocument();
        expect(screen.getByLabelText(/Product Details \/ Manual URL/i)).toBeInTheDocument();
    });

    test('ProductPackagingQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<ProductPackagingQRCodeLandingPage />);
    ...
    test('simulates user input and QR code generation', async () => {
        ...
        render(
            <HelmetProvider>
                <ProductPackagingQRCodeLandingPage />
            </HelmetProvider>
        );
