...
import GoogleDocsQRCodeLandingPage from '../Files & Tools/GoogleDocsQRCodeLandingPage';
...
describe('GoogleDocsQRCodeLandingPage Details', () => {

    test('GoogleDocsQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<GoogleDocsQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Google Docs to QR Code/i);
        expect(screen.getByLabelText(/Google Docs Share URL/i)).toBeInTheDocument();
    });

    test('GoogleDocsQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<GoogleDocsQRCodeLandingPage />);
