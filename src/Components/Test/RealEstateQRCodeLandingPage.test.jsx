...
import RealEstateQRCodeLandingPage from '../Business & Marketing/RealEstateQRCodeLandingPage';
...
describe('RealEstateQRCodeLandingPage Details', () => {

    test('RealEstateQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<RealEstateQRCodeLandingPage />);
        expect(screen.getAllByText(/Real Estate/i)[0]).toBeInTheDocument();
        expect(screen.getByLabelText(/Listing \/ Virtual Tour URL/i)).toBeInTheDocument();
    });

    test('RealEstateQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<RealEstateQRCodeLandingPage />);
