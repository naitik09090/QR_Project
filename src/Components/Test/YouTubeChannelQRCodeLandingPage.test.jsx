...
import YouTubeChannelQRCodeLandingPage from '../Social Media/YouTubeChannelQRCodeLandingPage';
...
describe('YouTubeChannelQRCodeLandingPage Details', () => {

    test('YouTubeChannelQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<YouTubeChannelQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/YouTube QR Codes/i);
        expect(screen.getByLabelText(/YouTube URL/i)).toBeInTheDocument();
    });

    test('YouTubeChannelQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<YouTubeChannelQRCodeLandingPage />);
    ...
    test('simulates user input and QR code generation', async () => {
        ...
        render(
            <HelmetProvider>
                <YouTubeChannelQRCodeLandingPage />
            </HelmetProvider>
        );
