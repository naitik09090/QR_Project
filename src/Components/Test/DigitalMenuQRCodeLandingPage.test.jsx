...
import DigitalMenuQRCodeLandingPage from '../Restaurant & Hospitality/DigitalMenuQRCodeLandingPage';
...
describe('DigitalMenuQRCodeLandingPage Details', () => {

    test('DigitalMenuQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<DigitalMenuQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Digital Menus/i);
        expect(screen.getByLabelText(/Restaurant or Cafe Name/i)).toBeInTheDocument();
    });

    test('DigitalMenuQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<DigitalMenuQRCodeLandingPage />);
