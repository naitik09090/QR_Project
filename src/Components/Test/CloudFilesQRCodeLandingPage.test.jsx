...
import CloudFilesQRCodeLandingPage from '../Files & Tools/CloudFilesQRCodeLandingPage';
...
describe('CloudFilesQRCodeLandingPage Details', () => {

    test('CloudFilesQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<CloudFilesQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Cloud Files to QR Code/i);
        expect(screen.getByLabelText(/Cloud Share URL/i)).toBeInTheDocument();
    });

    test('CloudFilesQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<CloudFilesQRCodeLandingPage />);
