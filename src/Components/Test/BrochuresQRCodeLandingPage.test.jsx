...
import BrochuresQRCodeLandingPage from '../Business & Marketing/BrochuresQRCodeLandingPage';
...
describe('BrochuresQRCodeLandingPage Details', () => {

    test('BrochuresQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<BrochuresQRCodeLandingPage />);
        expect(screen.getAllByText(/Brochures & Pamphlets/i)[0]).toBeInTheDocument();
        expect(screen.getByLabelText(/Digital Content URL/i)).toBeInTheDocument();
    });

    test('BrochuresQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<BrochuresQRCodeLandingPage />);
