...
import FreelancersQRCodeLandingPage from '../Payment_Qr_Pages/FreelancersQRCodeLandingPage';
...
describe('FreelancersQRCodeLandingPage Details', () => {

    test('FreelancersQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<FreelancersQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Freelancer QR Codes/i);
        expect(screen.getByLabelText(/Full Name \/ Brand Name/i)).toBeInTheDocument();
    });

    test('FreelancersQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<FreelancersQRCodeLandingPage />);
