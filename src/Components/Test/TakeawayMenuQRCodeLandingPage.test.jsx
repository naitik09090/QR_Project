...
import TakeawayMenuQRCodeLandingPage from '../Restaurant & Hospitality/TakeawayMenuQRCodeLandingPage';
...
describe('TakeawayMenuQRCodeLandingPage Details', () => {

    test('TakeawayMenuQRCodeLandingPage renders correctly', () => {
        renderWithHelmet(<TakeawayMenuQRCodeLandingPage />);
        expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent(/Takeaway QR Menus/i);
        expect(screen.getByLabelText(/Business Name/i)).toBeInTheDocument();
    });

    test('TakeawayMenuQRCodeLandingPage has common elements', () => {
        renderWithHelmet(<TakeawayMenuQRCodeLandingPage />);
